<template>
  <el-form ref="formRef" :model="form" :rules="rules" :label-width="options.labelWidth">
    <el-row>
      <el-col :span="options.span" v-for="item in options.list">
        <el-form-item :label="item.label" :prop="item.prop">
          ...
          <el-input v-if="item.type === 'input'" v-model="item.prop" :disabled="item.disabled"
                    :placeholder="item.placeholder" clearable></el-input>
          <el-input v-else-if="item.type === 'textarea'" v-model="item.prop" :disabled="item.disabled"
                    :placeholder="item.placeholder" type="textarea" autosize clearable></el-input>
          ...
          <el-switch v-else-if="item.type === 'switch'" v-model="item.prop"
    ...
    <el-form-item>
      <el-button type="primary" @click="saveEdit(formRef)">确 认</el-button>
    </el-form-item>
  </el-form>
</template>
