          ...
          <template #default="{ row, column, $index }" v-if="!item.type">
            <slot :name="item.prop" :rows="row" :index="$index">
              <template v-if="item.prop == 'operator'">
                ...
                <el-button type="success" size="small" :icon="Plus" @click="newProduct(row)" :disabled="row.dishStatus == '上架'">
                  上架
                </el-button>
                <el-button type="danger" size="small" :icon="Delete" @click="handleDelete(row)" :disabled="row.dishStatus == '下架'">
                  下架
                </el-button>
              </template>
...
import {Delete, Edit, View, Refresh, ChatDotRound, AddLocation, Plus} from '@element-plus/icons-vue';
